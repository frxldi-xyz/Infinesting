    ...
    run: async (client, interaction, args) => {
        ...
        const row = new Discord.ActionRowBuilder()
            .addComponents(
                new Discord.StringSelectMenuBuilder()
                    ...
                    .setPlaceholder('❌┆Belum ada yang dipilih')
                    .addOptions([
                        {
                            label: `Commands`,
        ...
        return client.embed({
            ...
            fields: [
                ...
                {
                    name: `🔗┆Links`,
                    value: `[Website](https://infinesting.id/) | [Invite](${client.config.discord.botInvite}) | [Vote](https://top.gg/bot/798144456528363550/vote)`
                },
            ],
            components: [row],
            type: 'editreply'
